    ...
    public List<String> getUserAuthoritiesByUsername(@PathVariable String username) {
        ...
        if (user != null){
            ...
            authorities = Arrays.asList(
                    ...
                    "Masjid-select","Masjid-delete","Masjid-update","Masjid-insert",
                    ...
                    "Masjid-select","Masjid-delete","Masjid-update","Masjid-insert",
                    "MsjType-select","Emp Reporte-select","MsjCity-select","MsjHouse-select",

                    "House-select","House-delete","House-update","House-insert",
                    "Sandah-select","Sandah-delete","Sandah-update","Sandah-insert",
                    "Sermon-select","Sermon-delete","Sermon-update","Sermon-insert",
                    "Member-select","Member-delete","Member-update","Member-insert",
                    "Event-select","Event-delete","Event-update","Event-insert",
                    "Receive-select","Receive-delete","Receive-update","Receive-insert",
                    "Salahtime-select","Salahtime-delete","Salahtime-update","Salahtime-insert"
