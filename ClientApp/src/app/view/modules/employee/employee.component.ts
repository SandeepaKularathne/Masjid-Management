...
export class EmployeeComponent {
  ...
  createForm() {
    ...
    this.form.controls['masjids'].setValidators([Validators.required]);
  ...
  fillForm(employee: Employee) {
    ...
    //@ts-ignore
    this.employee.masjid = this.masjids.find(s => s.id === this.employee.masjid.id);
